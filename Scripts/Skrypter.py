...
FOLDER_PATH = r"C:\Users\Admin\Desktop\TestTask"

# Lista podfolderów do pominięcia (nazwy relatywne do FOLDER_PATH)
FOLDERS_TO_SKIP = ['GooglePlayGames','Library','FacebookSDK']
...
extension = input("Podaj rozszerzenie plików (np. .cs): ")
...
if extension.lower() == '.cs':
    ...
    print(f"Zawartość plików .cs została skopiowana do {output_file}")
else:
    print("Funkcja kopiowania zawartości jest dostępna tylko dla plików .cs")
